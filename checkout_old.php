...
<body>
    ...
    <div class="checkout-container">
        ...
        <div class="checkout-footer">
            <p>Need help? Contact us at <a href="tel:<?php echo htmlspecialchars($settings['store_phone']); ?>" style="color: var(--checkout-primary);"><?php echo htmlspecialchars($settings['store_phone']); ?></a></p>
        </div>
    </div>
    ...
    <script>
        ...
        document.getElementById('checkoutForm').addEventListener('submit', async function(e) {
            ...
            let settings = {
                tax_rate: <?php echo $settings['tax_rate']; ?>,
                standard_delivery_fee: <?php echo $settings['standard_delivery_fee']; ?>,
                express_delivery_fee: <?php echo $settings['express_delivery_fee']; ?>
            };
            
            // Try to get latest settings from API
            try {
                const settingsResponse = await fetch('/jowaki_electrical_srvs/api/get_checkout_settings.php');
