...
if (!$conn) {
    error_log("Database connection failed", 3, __DIR__ . DIRECTORY_SEPARATOR . 'php_errors.log');
        ...
        <aside class="sidebar">
            <div class="sidebar-header">
                <div class="user-avatar">
                                         <img src="assets/images/Logo.jpg" alt="User Avatar" class="avatar-img">
    ...
    <div id="edit-profile-modal" class="modal">
        <div class="modal-content">
            ...
            <form id="edit-profile-form">
                ...
                <div class="form-group">
                    <label>Address</label>
                    <textarea name="address" rows="3"><?php echo htmlspecialchars($userExtra['address']); ?></textarea>
                </div>
                
                <div class="form-row">
                    <div class="form-group">
                        <label>City</label>
                        <input type="text" name="city" value="<?php echo htmlspecialchars($userExtra['city']); ?>">
                    </div>
                    <div class="form-group">
                        <label>Postal Code</label>
                        <input type="text" name="postal_code" value="<?php echo htmlspecialchars($userExtra['postal_code']); ?>">
                    </div>
                </div>
