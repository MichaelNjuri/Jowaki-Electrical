...
export function fetchOrders(state) {
    return fetch('../includes/get_orders_fixed.php', {
        credentials: 'include'
    })
        .then(response => {
...
export function viewOrder(orderId, state) {
    ...
    if (modal && content) {
        ...
        fetch(`../includes/order_details.php?id=${orderId}`)
...
export function updateOrderStatus(orderId, newStatus, state) {
    ...
    window.submitStatusUpdate = async (orderId, modal) => {
        ...
        try {
            ...
            const response = await fetch('../includes/update_order_status.php', {
                method: 'POST',
                headers: {
...
export function confirmOrder(orderId, state) {
    ...
    window.submitOrderConfirmation = async (orderId, modal) => {
        ...
        try {
            ...
            const response = await fetch('../includes/confirm_order.php', {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json'
                },
