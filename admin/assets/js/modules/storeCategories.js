...
export async function addStoreCategory(formData) {
    try {
        ...
        if (imageFile && imageFile.size > 0) {
            ...
            const addResponse = await fetch('../includes/store_categories_admin.php', {
                method: 'POST',
                headers: {
            ...
            response = await fetch('../includes/upload_category_image.php', {
                method: 'POST',
                body: formData
            });
        } else {
            ...
            response = await fetch('../includes/store_categories_admin.php', {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json',
                },
