...
function updateStats(stats) {
    ...
    if (pendingOrdersElement) {
        pendingOrdersElement.textContent = stats.pending_orders || 0;
    }
}
        ...
        return `
            <div class="order-item">
                ...
                <div class="order-items-preview">
                    ...
                    `).join('') || ''}
                    ${order.items && order.items.length > 3 ? `<div class="more-items">+${order.items.length - 3} more items</div>` : ''}
                </div>
                
                <div class="order-summary-preview">
                    <div class="summary-item">
                        <span class="summary-label">Total Items</span>
                        <span class="summary-value">${order.item_count || (order.items ? order.items.length : 0)}</span>
                    </div>
                    <div class="summary-item">
                        <span class="summary-label">Total Amount</span>
                        <span class="summary-value">KSh ${parseFloat(order.total || 0).toFixed(2)}</span>
                    </div>
                </div>
...
// Display order details in modal - simplified version
