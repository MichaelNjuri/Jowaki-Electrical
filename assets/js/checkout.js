...
function selectDelivery(method) {
    ...
    // Find the delivery option element and add selected class
...
function selectPayment(method) {
    ...
    // Find the payment option element and add selected class
    const paymentOption = document.querySelector(`input[value="${method}"]`).closest('.payment-option');
    if (paymentOption) {
...
async function placeOrder() {
    ...
    try {
        ...
        const orderData = {
            ...
            delivery_address: formData.get('address') + ', ' + formData.get('city') + ', ' + formData.get('postalCode'),
